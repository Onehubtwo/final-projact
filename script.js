...
const k=document.getElementsByClassName("delete-button")
...
function del(a){
     var r=0 ;
     total.innerHTML=parseFloat(total.innerHTML) - parseFloat(a.parentElement.parentElement.children[2].innerHTML)*parseInt(a.innerHTML)
     a.innerHTML=r ;
